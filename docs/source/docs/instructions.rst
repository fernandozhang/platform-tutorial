...
-----------
   ...
   浏览器输入无穹智图云平台登录网址： http://cscidtss.com
...
6.5.3激活成功之后会出现一个弹窗，用户可以点击弹窗，用户点击\ |instru085|\ 可以开始登录
...
6.5.4账户的登录账号和密码也会发送到您这个邮箱。
   ...
   6.5.5 可以用邮箱中的账户和密码登录 http://cscidtss.com/ 平台
